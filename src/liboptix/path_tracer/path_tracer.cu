...
RT_PROGRAM void pathtrace_camera()
{
  ...
  do {
    ...
    for(;;) {
	  ...
	  output_buffer[launch_index] = make_float4(prd.radiance*0.5+make_float3(0.5,0.5,0.5), 0.0f);
	  //output_buffer[launch_index] = make_float4(0.5, 0.5, 0.5, 0.0);
	  return;
	  ///////////////////////////////////
      if(prd.done) {
...
RT_PROGRAM void diffuse()
{
  ...
  ////temporary normal shading//////
  current_prd.radiance = world_shading_normal;
  return;
  //////////////////////////////////
...
RT_PROGRAM void miss()
{
  //current_prd.radiance = bg_color;
	current_prd.radiance = make_float3(0.0, 0.0, 1.0);
  current_prd.done = true;
}
