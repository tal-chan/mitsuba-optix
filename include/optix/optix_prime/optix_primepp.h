...
namespace optix {
  namespace prime {
    ...
    inline void ModelObj::setBuilderParameter( RTPbuilderparam param, RTPsize size, void* p )
    {
      CHK( rtpModelSetBuilderParameter(m_model, param, size, p) );
    }

    template<typename T>
    void optix::prime::ModelObj::setBuilderParameter( RTPbuilderparam param, T val )
    {
