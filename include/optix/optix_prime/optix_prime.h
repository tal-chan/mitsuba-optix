...
#define OPTIX_PRIME_VERSION 3080 /* 3.8.0 (major =  OPTIX_PRIME_VERSION/1000,     *
...
extern "C" {
  ...
  */
   ...
   * have been set (by calling rtpModelSetTriangles again with the updated values).
  ...
  */
   ...
   * set to 0 before the copy call. If the destination model has the build parameter set to 1 too,
   * it is necessary to specify the triangles of the destination model by calling @ref rtpModelSetTriangles
  ...
  */
   ...
   *
   */
  RTPresult RTPAPI rtpGetVersion( /*out*/ unsigned int* version );
