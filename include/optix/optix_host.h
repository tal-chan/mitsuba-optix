 ...
 ***********************************/
  ...
  * 
  * Note that a context that was used for remote rendering cannot be re-used for local 
  * rendering by changing devices. However, the Progressive API (that is, @ref rtContextLaunchProgressive2D, stream buffers, etc.) can be used locally by 
  * simply not creating a remote device and not calling @ref rtContextSetRemoteDevice. 
  * 
  ...
  * 
  */
  RTresult RTAPI rtContextSetRemoteDevice( 
          RTcontext context, 
  ...
  * @param[in]   entry_idx              The initial entry point into kernel
  ...
  * 
  */
  RTresult RTAPI rtContextLaunchProgressive2D(
          RTcontext context,
  ...
  * 
  */
  RTresult RTAPI rtContextStopProgressive(
          RTcontext context );
 ...
 ***********************************/
  ...
  */
  ...
  /**
  * @brief Check if stream buffer content has been updated by a Progressive Launch
  * 
  * @ingroup Buffer
  * 
  * <B>Description</B>
  * 
  * Returns whether or not the result of a progressive launch in \a stream has been updated 
  ...
  * only if) \a ready returns true. 
  * 
  * @param[in]   stream             The stream buffer to be queried
  ...
  * 
  */
  RTresult RTAPI rtBufferGetProgressiveUpdateReady(
          RTbuffer stream,
          int* ready,
  ...
  * of format @ref RT_FORMAT_UNSIGNED_BYTE4, and the output buffer must be of format @ref RT_FORMAT_FLOAT3 or @RT_FORMAT_FLOAT4.
  ...
  * 
  */
  RTresult RTAPI rtBufferBindProgressiveStream(
          RTbuffer stream,
          RTbuffer source );
  ...
  * 
  */
  RTresult RTAPI rtBufferSetAttribute(
          RTbuffer buffer, 
  ...
  * <B>Description</B>
  *
  * @ref rtBufferGetAttribute is used to query buffer attributes. For a list of available attributes, please refer to @rtBufferSetAttribute.
  * 
  ...
  * 
  */
  RTresult RTAPI rtBufferGetAttribute(
          RTbuffer buffer, 
          RTbufferattribute attrib,
          RTsize size, void* p );
  ...
  * 
  */
  RTresult RTAPI rtRemoteDeviceCreate( 
          const char* url, 
          const char* username, 
          const char* password, 
          RTremotedevice *remote_dev );
  ...
  * 
  */
  RTresult RTAPI rtRemoteDeviceDestroy( 
          RTremotedevice remote_dev );
  ...
  * 
  */
  RTresult RTAPI rtRemoteDeviceGetAttribute( 
          RTremotedevice remote_dev, 
  ...
  * attribute is set to @ref RT_REMOTE_DEVICE_STATUS_READY. 
  * 
  ...
  * 
  */
  RTresult RTAPI rtRemoteDeviceReserve( 
          RTremotedevice remote_dev, 
  ...
  * 
  */
  RTresult RTAPI rtRemoteDeviceRelease( 
          RTremotedevice remote_dev );
